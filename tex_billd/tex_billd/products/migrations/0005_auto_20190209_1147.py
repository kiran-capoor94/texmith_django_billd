# Generated by Django 2.1.5 on 2019-02-09 06:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0004_auto_20190206_0419'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='available_at',
            field=model_utils.fields.MonitorField(default=django.utils.timezone.now, monitor='status', when={'available'}),
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.AddField(
            model_name='product',
            name='company_name',
            field=models.CharField(default='Company Name', max_length=150, verbose_name='Product Company Name'),
        ),
        migrations.AddField(
            model_name='product',
            name='price_currency',
        ...
        migrations.AddField(
            model_name='product',
            name='serial_number',
            field=models.PositiveIntegerField(blank=True, default=0, verbose_name='Product Serial Number'),
        ),
        migrations.AddField(
            model_name='product',
            name='stock_changed',
            field=model_utils.fields.MonitorField(default=django.utils.timezone.now, monitor='available', verbose_name='Last Changed At'),
        ),
        migrations.AlterField(
            model_name='product',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=4, default=Decimal('0.0'), default_currency='INR', max_digits=19, verbose_name='Price'),
        ),
        migrations.AlterField(
            model_name='product',
            name='status',
            field=model_utils.fields.StatusField(choices=[(0, 'dummy')], default='notavail', max_length=100, no_check_for_status=True),
        ),
    ]
